...
public class CharacterActionModifyAttackRollViaPower : CharacterActionUsePower
{
    ...
    {
        modifyAttackRollViaPowerActionDefinition = SolastaBardClass.Helpers.CopyFeatureBuilder<ActionDefinition>
        ...
        modifyAttackRollViaPowerReactionDefinition = SolastaBardClass.Helpers.CopyFeatureBuilder<ReactionDefinition>
